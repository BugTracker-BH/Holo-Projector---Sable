# holo:hack/games/dodge/check_e1 — enemy 1 collision/respawn check
execute unless score #DG_E1_R holo.tmp matches 60.. run return 0
scoreboard players operation #DG_PE holo.tmp = #DG_PADDLE holo.tmp
scoreboard players add #DG_PE holo.tmp 6
scoreboard players operation #DG_EE holo.tmp = #DG_E1_C holo.tmp
scoreboard players add #DG_EE holo.tmp 2
scoreboard players set #DG_HIT holo.tmp 0
execute if score #DG_E1_C holo.tmp <= #DG_PE holo.tmp if score #DG_EE holo.tmp >= #DG_PADDLE holo.tmp run scoreboard players set #DG_HIT holo.tmp 1
...
scoreboard players set #DG_E1_R holo.tmp 0
