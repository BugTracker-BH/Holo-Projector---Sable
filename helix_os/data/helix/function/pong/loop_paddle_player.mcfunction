# helix:pong/loop_paddle_player — render 12 vertical pixels at x=4 and x=5
...
data modify storage helix:vm px set value 4
...
data modify storage helix:vm px set value 5
function helix:pong/setpx with storage helix:vm
scoreboard players add helix _pp_i 1
return run function helix:pong/loop_paddle_player
