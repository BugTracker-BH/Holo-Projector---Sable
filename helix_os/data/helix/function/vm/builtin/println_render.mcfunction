# helix:vm/builtin/println_render - MACRO: render _last_printed to holo projector
...
$execute if data storage helix:vm {_last_type:"null"} run function helix:_show {msg:"$(_last_printed)",color:"GRAY"}
