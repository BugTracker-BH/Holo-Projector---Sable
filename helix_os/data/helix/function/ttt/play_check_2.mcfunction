...
execute unless score helix ttt_c2 matches 0 run playsound minecraft:block.note_block.bass master @a ~ ~ ~ 0.6 0.6
execute unless score helix ttt_c2 matches 0 run return 0
scoreboard players operation helix ttt_c2 = helix ttt_player
scoreboard players set helix _ttt_cell 2
